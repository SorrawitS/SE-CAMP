        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ url('https://images.fineartamerica.com/images/artworkimages/mediumlarge/3/snoopy-woodstock-happy-kelli-p-holt.jpg') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">Sorrawit Sangmanee</a>
                    </div>
                </div>
